...
roteadorRoute.route("/save-roteador").put((req, res, next) => {
  ...
  roteadorModel.findByIdAndUpdate(
    result._id,
    {
      $set: result,
    },
    ...
    (res) => {
      ...
      switch (result.modelo) {
        ...
        case "zte corporation":
          result.modelo = "zte";
          break;
        case "TP-Link Corporation Limited":
          result.modelo = "tplink";
          break;
        case "Intelbras":
          result.modelo = "intelbras";
          break;
        case "Cianet Industria e Comercio S/A":
          result.modelo = "cianet";
          break;
        case "SHENZHEN GONGJIN ELECTRONICS CO.,LT":
          result.modelo = "zterouter";
          break;
        case "BaudTec Corporation":
          result.modelo = "multilaser";
          break;
        case "Fiberhome Telecommunication Technologies Co.,LTD":
          result.modelo = "fiberhome";
          break;
        case "Guangzhou V-SOLUTION Electronic Technology Co., Ltd.":
          result.modelo = "eb01";
          break;
        default:
